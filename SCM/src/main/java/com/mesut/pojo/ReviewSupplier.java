...
@NamedQueries({
    ...
    @NamedQuery(name = "ReviewSupplier.findByCreateDate", query = "SELECT r FROM ReviewSupplier r WHERE r.createDate = :createDate"),
...
public class ReviewSupplier implements Serializable {

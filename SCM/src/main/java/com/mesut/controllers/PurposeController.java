...
public class PurposeController {
     // Đổi
    private static final String BASE = "purposes";
    private static final String NAME = "purpose";
    ...
    @Autowired
    private PurposeService mainService;
    ...
    public String addView(Model model) {
        // Đổi class
        model.addAttribute("object", new Purpose());
        return FORM;
    }

    // Đổi class @ModelAttribute
    @PostMapping(URL_ADD_PROCESS)
    public String addProcess(@ModelAttribute(value = "object") Purpose o) {
        try {
    ...
    public String updateProcess(@ModelAttribute(value = "object") Purpose o) {
        try {
            this.mainService.addOrUpdate(o);

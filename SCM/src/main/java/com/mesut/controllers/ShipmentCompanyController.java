...
public class ShipmentCompanyController {
    // Đổi
    private static final String NAME = "shipment-company";
...
//    Đổi Service
    @Autowired
    private ShipmentCompanyService mainService;
    ...
    public String addView(Model model) {
        // Đổi class
        model.addAttribute("object", new ShipmentCompany());
        model.addAttribute("name", NAME);
        return FORM;
    }
    ...
    public String addProcess(@ModelAttribute(value = "object") ShipmentCompany o) {
        try {
    ...
    public String updateProcess(@ModelAttribute(value = "object") ShipmentCompany o) {
        try {
            this.mainService.addOrUpdate(o);
